...
const sampleDoctors: Doctor[] = [
  ...
  { id: 'd23', name: 'Dr. Anand Selvan', specialty: 'Nephrology', experience: 14, city: 'Chennai', fees: 1550, hospital: 'SIMS Hospital', bio: 'Specialist in kidney disease and dialysis at SIMS Hospital.', image: 'https://picsum.photos/400/400?random=23' },
    // Pune
  { id: 'd6', name: 'Dr. Vikram Singh', specialty: 'Gastroenterology', experience: 10, city: 'Pune', fees: 1300, hospital: 'Ruby Hall Clinic', bio: 'Specialist in digestive diseases and endoscopic procedures at Ruby Hall Clinic.', image: 'https://picsum.photos/400/400?random=6' },
  { id: 'd10', name: 'Dr. Sameer Patil', specialty: 'Dentist', experience: 12, city: 'Pune', fees: 650, hospital: 'Deenanath Mangeshkar Hospital', bio: 'Specialist in orthodontics and pediatric dentistry.', image: 'https://picsum.photos/400/400?random=10' },
  { id: 'd24', name: 'Dr. Aditi Deshpande', specialty: 'Gynecology', experience: 13, city: 'Pune', fees: 1200, hospital: 'Jehangir Hospital', bio: 'Consultant gynecologist at Jehangir Hospital.', image: 'https://picsum.photos/400/400?random=24' },
  { id: 'd25', name: 'Dr. Rohan Joshi', specialty: 'General Physician', experience: 8, city: 'Pune', fees: 750, hospital: 'Sahyadri Super Speciality Hospital', bio: 'General physician with a focus on preventive healthcare and chronic disease management.', image: 'https://picsum.photos/400/400?random=25' },
  { id: 'd26', name: 'Dr. Ishita Kulkarni', specialty: 'Pediatrics', experience: 9, city: 'Pune', fees: 800, hospital: 'KEM Hospital', bio: 'Focuses on neonatal care and child nutrition.', image: 'https://picsum.photos/400/400?random=26' },
   // Hyderabad
  { id: 'd5', name: 'Dr. Sunita Reddy', specialty: 'Pediatrics', experience: 18, city: 'Hyderabad', fees: 800, hospital: 'Rainbow Children\'s Hospital', bio: 'Compassionate pediatrician focused on child development and vaccination.', image: 'https://picsum.photos/400/400?random=5' },
  { id: 'd27', name: 'Dr. N.V. Rao', specialty: 'Cardiology', experience: 22, city: 'Hyderabad', fees: 1700, hospital: 'Care Hospitals', bio: 'Chief cardiologist at Care Hospitals, known for complex angioplasties.', image: 'https://picsum.photos/400/400?random=27' },
  { id: 'd28', name: 'Dr. Fatima Khan', specialty: 'Neurology', experience: 11, city: 'Hyderabad', fees: 1600, hospital: 'Continental Hospitals', bio: 'Expert in movement disorders at Continental Hospitals.', image: 'https://picsum.photos/400/400?random=28' },
  { id: 'd29', name: 'Dr. Arjun Kumar', specialty: 'Orthopedics', experience: 15, city: 'Hyderabad', fees: 1400, hospital: 'Yashoda Hospitals', bio: 'Specializes in sports injuries and arthroscopic surgery at Yashoda Hospitals.', image: 'https://picsum.photos/400/400?random=29' },
  { id: 'd30', name: 'Dr. Kavya Rao', specialty: 'Dermatology', experience: 7, city: 'Hyderabad', fees: 950, hospital: 'Apollo Hospitals, Jubilee Hills', bio: 'Aesthetic dermatologist specializing in anti-aging treatments.', image: 'https://picsum.photos/400/400?random=30' },
  // Kolkata
  { id: 'd31', name: 'Dr. A. K. Banerjee', specialty: 'Neurology', experience: 25, city: 'Kolkata', fees: 2200, hospital: 'Apollo Gleneagles Hospitals', bio: 'Senior Neurologist at Apollo Gleneagles Hospitals, Kolkata.', image: 'https://picsum.photos/400/400?random=31' },
  { id: 'd32', name: 'Dr. Mita Sen', specialty: 'Gynecology', experience: 18, city: 'Kolkata', fees: 1300, hospital: 'Fortis Hospital, Kolkata', bio: 'Specializes in high-risk pregnancies at Fortis Hospital, Kolkata.', image: 'https://picsum.photos/400/400?random=32' },
  { id: 'd33', name: 'Dr. Subrata Das', specialty: 'Cardiology', experience: 20, city: 'Kolkata', fees: 1800, hospital: 'Medica Superspecialty Hospital', bio: 'Interventional cardiologist at Medica Superspecialty Hospital.', image: 'https://picsum.photos/400/400?random=33' },
  { id: 'd34', name: 'Dr. Prosenjit Ghosh', specialty: 'Orthopedics', experience: 15, city: 'Kolkata', fees: 1100, hospital: 'AMRI Hospitals', bio: 'Joint replacement specialist at AMRI Hospitals.', image: 'https://picsum.photos/400/400?random=34' },
  { id: 'd35', name: 'Dr. Ishani Roy', specialty: 'Dermatology', experience: 10, city: 'Kolkata', fees: 900, hospital: ' Woodlands Multispeciality Hospital', bio: 'Cosmetic dermatologist with a clinic in Salt Lake.', image: 'https://picsum.photos/400/400?random=35' },
];
